 ...
 * All rights reserved
 *
 * Converted to Java by Software Toolworks
 */
package cohfdm;
...
public final class CohfdmTX implements IDefines {
    ...
    /**
     * Instantiate with Diversity option
     * true = Diversity, false = No Diversity
     *
     ...
     *
     * The output waveform is 600 symbols, and each baseband segment
     * is 100 symbols, so the offset variable is used to position the
     * mixed signal in the proper position of the waveform array.
     *
     * This is basically a Java thing, as you can't use pointers as in
     * the C macro assembler language types.
     *
